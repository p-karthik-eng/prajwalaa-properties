...
export default function AboutUs() {
  return (
    <section className="relative w-full bg-[#111111] text-white py-20 px-6 md:px-16 lg:px-24 overflow-hidden font-sans">
      {/* Decorative Grid Lines - Architecture / Blueprint Theme */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 border-b border-gray-800 pb-8">
          ...
          <p className="text-gray-300 max-w-xl mt-6 md:mt-0 text-md md:text-lg font-light leading-relaxed md:pl-6">
        ...
        {/* Content Layout - Split Structural Design */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
          
          {/* Left Column: The Foundation Statement */}
          <div className="lg:col-span-5 flex flex-col justify-between bg-[#161616] p-8 md:p-10 border-l-4 border-[#d39443]">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Pillar 1 */}
            <div className="bg-[#1c1c1c] p-8 flex flex-col justify-between hover:bg-[#222222] transition-colors duration-300">
              <div>
            ...
            <div className="bg-[#d39443] p-8 flex flex-col justify-center items-start text-[#111111]">
