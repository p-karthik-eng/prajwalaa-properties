              ...
              <div>
                ...
                <ul className="space-y-3.5 mb-8">
                  {option.features.map((feature, i) => (
                    <li key={i} className="flex items-start space-x-2.5 text-xs text-neutral-600 leading-normal">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            ...
            <div className="bg-neutral-50 rounded-2xl border border-neutral-100 p-6 flex flex-col justify-between h-full min-h-[220px]">
              <div>
                ...
                <div className="mb-4">
                  <span className="text-3xl md:text-4xl font-serif font-bold text-neutral-900">
                    ₹{calculateEstimate().toLocaleString("en-IN")}
                  </span>
                  {activeCalcPlan.unit.includes("per") && (
                    <span className="text-xs text-neutral-400 font-light block mt-1">
                ...
                <div className="flex items-start space-x-2.5 text-[11px] text-neutral-400 leading-normal mb-6">
